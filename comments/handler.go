...
import (
	...
	"github.com/red-gold/ts-serverless/micros/comments/router"
...
func init() {
	...
	config.InitCoreConfig("comments", &coreSetting.AppConfig, allSecrets)
...
// Comments handler
//
//encore:api public raw path=/comments/*p1
