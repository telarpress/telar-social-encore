...
func init() {
	...
	config.InitCoreConfig("actions", &coreSetting.AppConfig, allSecrets)

	// Init actions mirco
	config.InitActionConfig(&actionSetting.ActionConfig)
...
// Actions handler
//
//encore:api public raw path=/actions/*p1
